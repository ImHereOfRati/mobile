...
class AutoSendReadiness {
  ...
  AutoSendReadinessLevel get level =>
      isReady ? AutoSendReadinessLevel.ready : AutoSendReadinessLevel.needsAttention;

  String get summaryTitle {
    if (isReady) {
      return '자동 전송 준비 완료';
    }
    return '도착 알림 준비 $remainingSteps단계 남음';
  }
  ...
  String get primaryActionLabel => isReady ? '준비 상태 보기' : '자동 전송 준비하기';
  ...
  String get locationStatusLabel {
    ...
    if (locationPermission == PermissionState.grantedWhenInUse) return '사용 중 허용';
