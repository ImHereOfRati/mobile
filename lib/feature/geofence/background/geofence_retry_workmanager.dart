...
void geofenceRetryCallbackDispatcher() {
  Workmanager().executeTask((task, inputData) async {
    try {
      ...
      await DrainDeliveryQueueUseCase(
        pipeline: GetIt.instance<GeofenceDeliveryPipeline>(),
        retryScheduler: GetIt.instance<GeofenceRetryScheduler>(),
      ).execute(replaceExistingSchedule: false);
      return true;
    } catch (e, st) {
